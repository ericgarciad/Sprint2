...
INSERT INTO 
frame (frame_id, frame_type, frame_color_id)
VALUES 
(1, 'pasta', 1),
(2, 'metalica', 2),
(3, 'flotant', 3);
...
INSERT INTO 
glasses (glasses_id, brand_id, graduation_left, graduation_right, frame_id, crystal_color_id, price)
VALUES 
(1, 1, 2.4, 2.1, 1, 1, 99.5),
(2, 2, 0.4, 0.5, 2, 2, 110.5),
(3, 3, 1.4, 1.1, 3, 3, 209.5);
